...
import { StyleSheet, Text, TextInput, TouchableOpacity, View, Alert, AsyncStorage } from 'react-native';
	...
	onComplete = () => {
		...
		recordEvent = () => {
			Analytics.record({
				...
				attributes: { username: this.state.email }
			});
		};
			...
			<View style={{ flex: 1 }}>
				<KeyboardAwareScrollView enableOnAndroid extraScrollHeight={130}>
					<View style={Global.container}>
						...
						<View style={this.isFormValid() ? Global.formContainer : { width: '100%', marginTop: 10 }}>
						...
						<View style={Buttons.container}>
							...
							<TouchableOpacity
								...
								onPress={() => {
									...
									this.isFormValid() ? this.handleSubmit(newUser) : console.log('Form has errors');
								}}
							>
				...
				<View style={su_styles.bottomNav} />
			</View>
		);
	}
}
