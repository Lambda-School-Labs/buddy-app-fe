...
import { StyleSheet, TouchableOpacity, Text, View, ImageBackground, Image, AsyncStorage } from 'react-native';
		...
		<ImageBackground style={landing.background} source={require('../assets/landing-background.png')}>
			<View style={landing.container}>
				...
				<View style={landing.buttonContainer}>
					<TouchableOpacity
						onPress={this.trackEventSignIn.bind(this)}
						style={[ Buttons.btn, Buttons.secondary ]}
					>
						<Text style={[ Buttons.textAuth ]}>Sign In</Text>
					</TouchableOpacity>
					<TouchableOpacity
						onPress={this.trackEventSignUp.bind(this)}
...
export default connect(mapStateToProps, { addUser })(Landing);
